            ...
            <div class="col-md-12">
              <div class="card card-default">
                <div class="card-header">
                  <h3 class="card-title">Driver Booking Form</h3>
                </div>
                  ...
                  <div class="bs-stepper">
                    ...
                    <div class="bs-stepper-content">
                      <!-- your steps content here -->
                        <form action="{{ route('store_book_driver') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                      
                            <div id="step1" class="content" role="tabpanel" aria-labelledby="step1-trigger">
                                <div class="form-group">
                                    <label for="driver_name">Select Driver</label>
                                    <select name="driver_name" id="driver_name" class="form-control select2bs4" required>
                                        <option value="" selected disabled>- Select Driver -</option>
                                        @foreach ($get_driver as $driver_list)
                                            <option value="{{ $driver_list->id_tbl_driver }}">{{ $driver_list->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="row">
